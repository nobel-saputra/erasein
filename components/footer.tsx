...
export function Footer() {
  ...
  return (
    <footer className="bg-surface-container-low w-full py-12 mt-20 border-t border-outline-variant relative z-10">
      {/* Main Grid Container */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-stack-lg lg:gap-gutter max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        {/* Column 1: Brand */}
        ...
        <div className="flex flex-col">
          ...
          <ul className="space-y-stack-sm flex flex-col">
            <li><a className="font-body-sm text-body-sm text-on-surface-variant hover:text-primary transition-colors opacity-80 hover:opacity-100 block py-1" href="#">Privacy Policy</a></li>
            <li><a className="font-body-sm text-body-sm text-on-surface-variant hover:text-primary transition-colors opacity-80 hover:opacity-100 block py-1" href="#">Terms of Service</a></li>
            <li><a className="font-body-sm text-body-sm text-on-surface-variant hover:text-primary transition-colors opacity-80 hover:opacity-100 block py-1" href="#">Support</a></li>
          </ul>
        </div>
      </div>
      {/* Bottom Copyright */}
